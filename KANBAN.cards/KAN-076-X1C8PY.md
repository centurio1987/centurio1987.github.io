...
- 2026-08-30T14:53 · s:c6a8fb52 — S8(검토 항목 4 승인으로 추가): 자가검사 자기 축소를 래칫이 문다 — selftest.ts 가 FAULT_COUNT 를 내보내고 기준선 selfTestFaults 가 그것을 들며, 줄면 실패한다. 죽여서 확인 2회: RECOGNIZERS 에서 인식기 제거(12→10) · 고장 하나 삭제(12→11) 둘 다 빨개진다 — 직전까지 둘 다 조용히 통과하던 자리다. 옛 기준선(필드 없음)은 검사를 건너뛴다. tokens:invariant·build 재확인 통과, src/ 무변경
