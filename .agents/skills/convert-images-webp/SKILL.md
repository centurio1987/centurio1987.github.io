...
```bash
python3 .agents/skills/convert-images-webp/scripts/convert_images_webp.py
```
...
```bash
python3 .agents/skills/convert-images-webp/scripts/convert_images_webp.py --apply
```
...
```bash
python3 .agents/skills/convert-images-webp/scripts/convert_images_webp.py --apply --delete-originals
```
