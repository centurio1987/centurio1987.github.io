...
const resumeData = reactive<ResumeData>({
  ...
  profile: `공감하는 제품을 만듭니다. 고객의 만족, 기업의 가치, 팀의 인스피레이션을 삼각 축으로 하여, 최대 가치를 담아 내려 합니다.
...
@media print {
  ...
  /* 경력 항목은 내용이 길 수 있으므로 페이지 분할 허용 */
  .resume-content .timeline-item.page-break-inside-avoid {
