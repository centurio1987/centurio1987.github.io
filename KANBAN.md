...
- `KAN-065` 문체 스윕 후 graph:refresh 1회 (graph.json 라벨 낡음) — 생성:ai · 최종:ai · 갱신:2026-08-04
  ...
  - 원문:
    ...
    ```
- `KAN-067-NH9SDQ` 폭신 대담에서 사용할 주제는 아래와 같다. 미리 주제에 대해 리서치를 하고, 대화를 대비한 준비를 해둬라. — 생성:유저 · 최종:ai · 갱신:2026-08-15
...
- `KAN-064` 집필 엔진 교체(authoring-kit)에 따른 기존 글 재집필 계획 수립 — 생성:유저 · 최종:ai · 갱신:2026-08-04
  ...
  - 원문:
    ...
    ```
- `KAN-066-KK9Q50` 폭신 대담: 대화 원본 → 정형 구조화 저장 기능 (원문 보존 포함) — 생성:유저 · 최종:ai · 갱신:2026-08-16
  ...
  - 실행 문서: KANBAN.cards/KAN-066-KK9Q50.md (7/7 · 최근 08-16)
  - 검토 문서: KANBAN.reviews/KAN-066-KK9Q50.review.md (판단 0/6 · 검토 대기)
  - 원문:
    ```text
