...
- `KAN-072.5-WQV1KT` 간격 축 토큰화 — 스케일 밖 여백을 --space-* 로 (구획 순서로 위험을 뒤로) — 생성:ai · 최종:ai · 갱신:2026-08-25
  - 상위: `KAN-072-CPJCT1` (진행 중)
  - 짧은 제목: 간격 축 토큰화
...
- `KAN-072.6-2YYK6V` 제2 팔레트 정리 — 글 안 시뮬 389 · 마스코트 28 · 카탈로그/데코/viz 103 — 생성:ai · 최종:ai · 갱신:2026-08-25
  - 상위: `KAN-072-CPJCT1` (진행 중)
  - 짧은 제목: 제2 팔레트 정리
...
- `KAN-071-6361MY` 선언 층을 줄인다 — bbangtoTonyStyleGuide export 를 걷고 foundation 만 남긴다 — 생성:ai · 최종:ai · 갱신:2026-08-25
  ...
  - 원문:
    ...
    ```
- `KAN-072.1-5XC1AT` 판단 없는 치환 — 드리프트 71 · 못 가르는 색 46 · fallback 23 — 생성:ai · 최종:ai · 갱신:2026-08-25
  - 상위: `KAN-072-CPJCT1` (진행 중)
  - 짧은 제목: 판단 없는 치환
