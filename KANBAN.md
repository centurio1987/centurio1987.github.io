...
- `KAN-072.4-GJ9M4N` 글자 축 토큰화 — 문서 역할값 밖 166건을 --text-* 로 — 생성:ai · 최종:ai · 갱신:2026-08-25
  - 상위: `KAN-072-CPJCT1` (진행 중)
  - 짧은 제목: 글자 축 토큰화
...
- `KAN-072-CPJCT1` UI 토큰 정합화 — 게이트가 무는 1,786건을 구획 단위로 0 으로 줄인다 — 생성:ai · 최종:ai · 갱신:2026-08-27
  - 짧은 제목: 토큰 정합화
  ...
  - 실행 문서: KANBAN.cards/KAN-072-CPJCT1.md (11/16 · 최근 08-27)
  - 계획 리포트: KANBAN.reports/KAN-072-CPJCT1.report.html (낡음)
  - 원문:
    ```text
    위 artifact를 보고 전략과 실행 계획을 수립해라
    ```
- `KAN-072.7-D6DCXJ` 게이트 인식층 — 토큰 이름 규칙을 하드코딩에서 데이터로 뺀다 — 생성:ai · 최종:ai · 갱신:2026-08-27
  - 상위: `KAN-072-CPJCT1` (진행 중)
  - 짧은 제목: 게이트 인식층
...
- `KAN-072.2-BF75X5` 토큰 체계 보강 — 종이 흰색 · 선 굵기 2단 · radius · 상태색 · 간격/글자 스케일 토큰 — 생성:ai · 최종:ai · 갱신:2026-08-27
  - 상위: `KAN-072-CPJCT1` (진행 중)
  - 짧은 제목: 토큰 체계 보강
...
- `KAN-072.1-5XC1AT` 판단 없는 치환 — 드리프트 71 · 못 가르는 색 46 · fallback 23 — 생성:ai · 최종:ai · 갱신:2026-08-27
  - 상위: `KAN-072-CPJCT1` (진행 중)
  - 짧은 제목: 판단 없는 치환
...
- `KAN-072.5-WQV1KT` 간격 축 토큰화 — 스케일 밖 여백을 --space-* 로 (구획 순서로 위험을 뒤로) — 생성:ai · 최종:ai · 갱신:2026-08-27
  - 상위: `KAN-072-CPJCT1` (진행 중)
  - 짧은 제목: 간격 축 토큰화
...
- `KAN-072.6-2YYK6V` 제2 팔레트 정리 — 글 안 시뮬 389 · 마스코트 28 · 카탈로그/데코/viz 103 — 생성:ai · 최종:ai · 갱신:2026-08-27
  - 상위: `KAN-072-CPJCT1` (진행 중)
  - 짧은 제목: 제2 팔레트 정리
