...
- `KAN-064` 집필 엔진 교체(authoring-kit)에 따른 기존 글 재집필 계획 수립 — 생성:유저 · 최종:ai · 갱신:2026-08-04
  ...
  - 원문:
    ...
    ```
- `KAN-070-DRF0QF` UI 토큰 게이트를 세운다 — verify-tokens 래칫 신설과 집필 규칙 개정 — 생성:ai · 최종:ai · 갱신:2026-08-25
  - 짧은 제목: 토큰 게이트 신설
  ...
  - 검토 문서: KANBAN.reviews/KAN-070-DRF0QF.review.md (승인 4/6 · 추가 의견 1 · 반려 1 · 추가 의견 총 6 · 검토 대기)
  - 원문:
    ```text
    위 artifact를 보고 전략과 실행 계획을 수립해라
    ```
