...
- `KAN-077-RA2SYG` 게이트 회피 경로를 막는다 — 상수로 끌어올린 리터럴 15건을 판정에 넣는다 — 생성:ai · 최종:ai · 갱신:2026-08-30
  - 짧은 제목: 상수 승격 리터럴
  ...
  - 검토 문서: KANBAN.reviews/KAN-077-RA2SYG.review.md (승인 3/5 · 추가 의견 2 · 추가 의견 총 2 · 검토 대기)
