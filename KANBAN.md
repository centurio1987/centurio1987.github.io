...
- `KAN-080-WTQ7AV` 타이포그래피가 하나의 디자인 스타일 안에서 일관성 없이 정의되어 있다. 하나의 디자인 스타일을 준수하는 타이포그래피 조합을 조사하여 채택해라. — 생성:유저 · 최종:ai · 갱신:2026-09-01
  - 짧은 제목: 타이포그래피 체계 채택
  ...
  - 실행 문서: KANBAN.cards/KAN-080-WTQ7AV.md (13/19 · 최근 09-03)
  - 원문:
    ```text
